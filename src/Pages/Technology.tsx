...
const Technology: React.FC = () => {
  ...
  return (
    ...
    >
      <Navbar />
      {/* Butoane poziționate separat */}
      <div className="absolute left-[9vw] top-[40.5vh] flex flex-col gap-[4.5vh]">
        {techItems.map((item, index) => (
          <button
            key={index}
            onClick={() => setSelected(item)}
            className={`w-[5vw] h-[5vw] rounded-full border border-white flex items-center justify-center text-[1.5vw] font-['Bellefair'] transition-all duration-300 ${
      ...
      <div className="flex justify-between items-start w-[80vw] ml-[10vw] mt-[10vh]">
        {/* Text */}
        <div className="flex flex-col gap-[2vh] max-w-[32vw] ml-[7.8vw]">
      ...
      <img
        src={selected.image}
        alt={selected.name}
        className="absolute w-[35.82vw] h-[65.8vh] right-0 top-[26.18vh] object-cover"
      />
    </section>
  );
};
